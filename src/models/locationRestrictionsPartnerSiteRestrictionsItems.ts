...
export interface LocationRestrictionsPartnerSiteRestrictionsItems {
  /**
...
export const locationRestrictionsPartnerSiteRestrictionsItemsSchema: Schema<LocationRestrictionsPartnerSiteRestrictionsItems> = object(
  {
