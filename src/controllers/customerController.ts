...
} from '../models/createCardGroupRequest.js';
import {
  CreateCardGroupRes,
  createCardGroupResSchema,
} from '../models/createCardGroupRes.js';
...
} from '../models/updateCardGroupRequest.js';
import {
  UpdateCardGroupRes,
  updateCardGroupResSchema,
} from '../models/updateCardGroupRes.js';
...
export class CustomerController extends BaseController {
  ...
  async customercreatecardgroup(
    ...
    const mapped = req.prepareArgs({
      requestId: [requestId, string()],
      body: [body, createCardGroupRequestSchema],
    });
    req.header('RequestId', mapped.requestId);
    req.header('Content-Type', 'application/json');
    req.json(mapped.body);
  ...
  async customerupdatecardgroup(
    ...
    const mapped = req.prepareArgs({
      requestId: [requestId, string()],
      body: [body, updateCardGroupRequestSchema],
    });
    req.header('RequestId', mapped.requestId);
    req.header('Content-Type', 'application/json');
    req.json(mapped.body);
