...
| `name` | `string \| null` | Required | Name of Purchase category .<br><br>**Constraints**: *Maximum Length*: `30` |
...
| `productGroups` | [`ProductGroup[]`](../../doc/models/product-group.md) | Required | List of product sets<br><br>**Constraints**: *Unique Items Required* |
